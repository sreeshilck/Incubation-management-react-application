...
function BookingSlots2() {
    ...
    const selectSlot = async() => {
        ...
        if (selectedCompany === '') {
            ...
            const res = await axios.post("http://localhost:5000/selected", dataid)
                console.log(res);
                setRefresh(res)
    ...
    const onpage = async () => {
        try {
            const response = await axios.get("http://localhost:5000/bookingslots")
            ...
            const appData = await axios.get("http://localhost:5000/applications")
                                    ...
                                    <FormControl fullWidth>
                                        ...
                                        >
                                            {company.map((data) => (
                                                ...
                                                <MenuItem value={data._id}>{!data.slot && data.name}</MenuItem> 
                                                // :
                                                //  ""}
                                            ))}
